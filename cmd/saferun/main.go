...
import (
	...
	"github.com/saferun/saferun/pkg/sandbox"
...
var rootCmd = &cobra.Command{
	...
	Long: `SafeRun == Run your projects in a secure sandbox automatically
...
Examples:
  ...
  saferun --network=whitelist pip install -r requirements.txt`,
	RunE: runSandbox,
